...
const SESSIONS = [
  {
    ...
    talks: [
      { speaker: "Eleanor Rieffel", affiliation: "University of Queensland", title: "A tour of the many faces of distributed quantum algorithms", kind: "invited", mins: 25,
      ...
      { speaker: "Hanyu Wang", affiliation: "UCLA", title: "Structure-Aware Synthesis for Fault-Tolerant Quantum Compilation", kind: "invited", mins: 25,
      ...
      { speaker: "Anita Buckley", affiliation: "USI", title: "Formal reasoning about quantum networks - Specification and verification of quantum network protocols", kind: "invited", mins: 25,
...
Probabilistic BellKAT extends the language with primitives for expressing probabilistic and nondeterministic behavior, along with semantics designed for quantitative analysis of real-world protocols. We further implement a tool to automate the use of BellKAT for protocol verification and optimization.`,
...

  {
    ...
    talks: [
      { speaker: "Ada Warren", affiliation: "IonQ / UofT", title: "Interconnect Multiplexing Requirements for Distributed Quantum Computing", abstract: "Distributed quantum computing requires generation of high-fidelity entangled pairs shared between remote nodes. Entanglement generation rates are limited by the efficiency of the optical interconnects connecting these nodes. Since remote quantum operations consume large numbers of these entangled pairs, high entanglement generation rates are needed for scalable distributed quantum computing, making multiplexed interconnects an expensive necessity. It is therefore necessary to carefully consider the entanglement distribution protocol used to maximize resource utilization. To this end, we construct a framework for analyzing entanglement distribution protocols in terms of their multiplexing requirements. We apply our framework to the double-click entanglement distribution protocol that relies on coincident-photon-pair detection and compare it to a memory-assisted protocol which achieves increased pair generation rates at the cost of additional noise. We find that in the presence of high transmission losses and low memory error rates, memory-assisted protocols can achieve the same entanglement generation rates using as much as an order of magnitude fewer interconnects.", kind: "invited", mins: 22 },
      ...
      { speaker: "Nikitha Nunavath", affiliation: "TU Dresden", title: "When Does Coherent Quantum Closure Phase Help? A Cross-Layer DQC Benchmark for HEP Telescope Networks", kind: "paper", paper: "1789", mins: 12,
        ...
        note: "Due to unforeseen circumstances, Riccardo Bassoli can no longer present. Instead, research colleague Nikitha Nunavath, who will already be attending QCE 2026, will present paper 1789 on behalf of the authors."
       }
    ],
...

  {
    ...
    talks: [
      ...
      { speaker: "Abram Falk", affiliation: "IBM", title: "Extending quantum computing through modularity", abstract: "As the scale of superconducting quantum computers grows, modular architectures are playing an increasingly important role. Modularity can be hierarchical and take several forms, including real-time classical communication, short- and long-range microwave links between quantum processors, and room-temperature optical connections relying on quantum transducers. In this talk, I will discuss modular architectures in the context of existing and planned IBM quantum computers. I will present a model mapping the properties of transducers to two-qubit gate fidelities that illuminates how close to viability it is. Moreover, I will discuss a simple entanglement distillation protocol designed to mitigate errors deriving from transducers, which was inspired by recent demonstrations of remote entanglement in defect qubits. Together with continually increasing connectivity and decreasing error rates, modularity is a key element contributing to the growth of forthcoming quantum computers.", kind: "invited", mins: 22 },
      { speaker: "Robert Stockill", affiliation: "QphoX", title: "Quantum transduction for networked quantum processors", abstract: `While rapid progress continues towards quantum processors with the capacity for real impact, processor sizes ultimately remain constrained by the stringent requirements for manipulating, storing and measuring quantum information at scale. To this end photonic interfaces and interconnects can reshape how these systems scale by providing the physical infrastructure behind distributed quantum computing. QphoX is building the specific hardware that allows previously isolated quantum processors to network via room temperature optical interconnects. In this talk I will cover the approach we take to realise these interconnects via integrated microwave-to-optical transduction, how the performance of these interfaces is evolving and the key outstanding challenges and waypoints towards the realisation of distributed quantum datacentres.`, kind: "invited", mins: 22 },
